...
p<- h + geom_path(data=retreating, aes(long, lat, size=survivors, color=direction), linejoin = "bevel", lineend="butt") +
  geom_path(data=rtr2, aes(long, lat, size=survivors, color=direction), linejoin = "bevel", lineend="butt") + 
  geom_path(data=rtr3, aes(long, lat, size=survivors, color=direction), linejoin = "bevel", lineend="butt") + 
    geom_path(data=adv3, aes(long, lat, size=survivors, color=direction), linejoin = "bevel", lineend="butt") + 
  geom_path(data=adv2, aes(long, lat, size=survivors, color=direction), linejoin = "bevel", lineend="butt") + 
geom_path(aes(color=direction), linejoin = "bevel", lineend="butt")

p +  theme(panel.background=element_rect(fill="white", colour="grey", linewidth = 1), panel.grid = element_line(colour="lightgrey"),
                 legend.position="none", 
) + geom_text(data=nap$cities, aes(label=city, size=10, y=lat+.1)) + scale_size(range=c(2, 10))
```
...
ggplot(temps, aes(long, temp)) + geom_line() + theme(
