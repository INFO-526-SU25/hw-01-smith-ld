...
```
This data documents fatalities by weekday, time of day, and the severity. This coul dbe in an attempt to identify rom for improvement, or road planning, or an initial discovery for root cause identification and further fatality prevention. We also notice that fatal severity occurs mostly on the weekends, and not during the week; there are 3 major spikes - around 10pm, early morning, and around noon. 
